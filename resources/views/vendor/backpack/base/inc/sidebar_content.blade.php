...
@can('admin')
    ...
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('railway') }}'><i class='nav-icon la la-sitemap'></i> Катта корхоналар</a></li>
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('organization') }}'><i class='nav-icon la la-sitemap'></i> Корхоналар </a></li>
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('position') }}'><i class='nav-icon la la-star'></i> Лавозимлар </a></li>
    <li class='nav-item'><a class='nav-link' href='{{ backpack_url('education') }}'><i class='nav-icon la la-info'></i> Маълумот </a></li>
    ...
    <li class="nav-item nav-dropdown">
        ...
        <ul class="nav-dropdown-items">
            <li class="nav-item"><a class="nav-link" href="{{ backpack_url('user') }}"><i class="nav-icon la la-user"></i> <span>Фойдаланувчилар</span></a></li>
