...
@section('header')
    <div class="container-fluid">
        <h2>
            <span class="text-capitalize"> {{ $manag_name }} - {{$org_name}} - {{$user_name}} - {{$dep_name}} - {{$pos_name}}</span>
            <small id="datatable_info_stack"> Ходимлар кўрсаткичлари </small>
        </h2>
    </div>
@endsection
                ...
                @if (count($a))
                    @foreach ($a as $key => $value)
                        <tr>
                            ...
                            <td>
                                <a type="button" href="" class="btn btn-sm btn-success"><i
